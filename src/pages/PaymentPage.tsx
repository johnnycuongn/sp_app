...
import { Payment, PaymentInput, createPayment, deletePayment, getPayment, listPayments, updatePayment, useLookups } from "../api"
  ...
  return (
    <Box sx={{ p: { xs: 2, md: 3 }, maxWidth: 1200, mx: "auto" }}>
      ...
      <Dialog open={modalOpen} onClose={close} maxWidth="sm" fullWidth>
        <DialogTitle>
          {editingId ? "Payment information" : "Add new payment method"}
        </DialogTitle>
        <DialogContent>
